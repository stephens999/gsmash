---
title: "run PMF on pbmc, nonnegative Loadings and Factors, more iterations"
author: "DongyueXie"
date: "2022-12-18"
...
I run splitting PMF on the pbmc data with nonnegative loadings. [Previous one](run_PMF_on_pbmc_nonnegativeLF.html) was run 200 iterations.

```{r}
rmse = function(x,y){return(sqrt(mean((x-y)^2)))}
res = readRDS('/project2/mstephens/dongyue/poisson_mf/pbmc_full_Sij_nonnegativeLF.rds')
fit = res$fit
```
