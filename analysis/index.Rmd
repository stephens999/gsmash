...
* [run PMF on PBMC data, 3 cell types, nonnegative loadings](run_PMF_on_pbmc_3cells_nonnegativeL.html)
* [run PMF on PBMC data, 3 cell types, nonnegative loadings and factors](run_PMF_on_pbmc_3cells_nonnegativeLF.html)
* [run PMF on PBMC data](run_PMF_on_pbmc.html)
* [run PMF on PBMC data,nonnegative Loadings](run_PMF_on_pbmc_nonnegativeL.html)
* [run PMF on PBMC data,nonnegative Loadings and factors](run_PMF_on_pbmc_nonnegativeLF.html)
