---
title: "run PMF on pbmc data, 3 cells, nonnegative Loadings and factors"
author: "DongyueXie"
date: "2022-12-18"
...
All settings are the same as a [previously one](run_PMF_on_pbmc_3cells.html) where there's no sign constraint on loadings and factors.

Except I set the loadings and factors to be nonnegative.
