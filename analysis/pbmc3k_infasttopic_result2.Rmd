...
Note: compared to [previous results](pbmc3k_infasttopic_result.html), I changed the initialization for ebpm_normal from log(1+x/s) to ebpm_exponential_mixture posterior log of mean.
