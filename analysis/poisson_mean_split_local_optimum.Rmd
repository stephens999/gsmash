...
On the other hand, if $g_b$ goes to a non-pointmass, then $\sigma^2$ can converge to a smaller value, but not 0. In this simulation we know that true $\sigma^2$ is 0, and in this case the estimated $\sigma^2$ converges to 0.22. 
